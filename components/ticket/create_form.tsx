...
import { createTicket } from "@/app/profile/ticket/actions";
...
const CreateForm = (props: Props) => {
  ...
  const form = useForm<z.infer<typeof ticket_schema>>({
    resolver: zodResolver(ticket_schema),
    defaultValues: {
      title: "",
      message: "",
      relatedId: "",
  ...
  const onSubmit = (values: z.infer<typeof ticket_schema>) => {
    nProgress.start();
