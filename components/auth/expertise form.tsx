        ...
        : (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Pick one and starting diving into the world of developers
              </CardDescription>
            </CardHeader>
            <CardContent>
              {(
            ...
            <CardFooter className="flex flex-row-reverse">
              <form action={formAction}>
                <input
                  type="hidden"
                  name="data"
                  value={JSON.stringify(selected.map((item) => item.id))}
                />
                <Button type="submit" className="hover:bg-accent font-bold">
                  All set? Let's GOOO😆
                </Button>
              </form>
            </CardFooter>
